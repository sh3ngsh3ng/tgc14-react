...
export default class TaskList extends React.Component {
    ...
    updateFormFieldEx = (stateKey, fieldName, value) => {
        let clonedTask = {...this.state[stateKey], [fieldName]: value};
        this.setState({
            [stateKey] : clonedTask
        })
    }
    ...
    render() {
        return (<React.Fragment>
            ...
            <TaskForm
                ...
                updateField={(evt)=>{
                   this.updateFieldEx('newTask', evt.target.name, evt.target.value)
                }}
                onDone={this.processAddTask}
            />
